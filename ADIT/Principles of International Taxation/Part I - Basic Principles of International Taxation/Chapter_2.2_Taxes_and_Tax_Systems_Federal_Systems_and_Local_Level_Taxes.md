...
```
EXAM INTELLIGENCE: Federal Systems and Local-Level Taxes
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
WHY INCLUDED: Understanding how taxes are levied at different
government levels is essential for analyzing treaty coverage
and avoiding double taxation at multiple jurisdictional levels.
...
|--------|----------------|----------|
| **Federal** | Multiple levels of government with independent taxing powers | USA, Canada, Australia, Germany, Switzerland, India, Brazil |
...
|-----------------|---------------------|
| Central government | 53.1% |
| Social security funds | 21.5% |
| State/regional level | 17.6% |
| Local level | 7.5% |

**Unitary Countries (28 OECD members)**:
| Government Level | Average Revenue Share |
|-----------------|---------------------|
| Central government | 64.8% |
| Social security funds | 25.0% |
| Local level | 9.8% |

**Range of Variation**:
- Central government share: 29.9% (France) to 93.5% (New Zealand)
- Local government share: 0.6% (Estonia) to 35.7% (Sweden)
...
**Core Principles** (Richard Musgrave, 1959):

| Government Function | Best Level | Rationale |
|--------------------|------------|-----------|
| **Stabilization** | Federal/Central | Only national government large enough to affect overall economic activity |
| **Redistribution** | Federal/Central | Prevents "race to the bottom" in welfare provision |
| **Allocation** | State/Local | Better knowledge of local preferences and needs |

**Tax Assignment Principles**:

| Tax Type | Recommended Level | Reasoning |
|----------|------------------|-----------|
...
| Typical Taxes | Characteristics |
|--------------|-----------------|
| Personal income tax | Progressive rates, broad base |
| Corporate income tax | Uniform rate nationwide |
| VAT/GST | National consumption tax |
| Customs duties | Border levies |
| Social security taxes | Earmarked for specific programs |

#### State/Regional Government

| Typical Taxes | Characteristics |
|--------------|-----------------|
| State income tax | May piggyback on federal base |
| State sales tax | Rates vary by state |
| State corporate tax | May differ from federal |
| Motor vehicle taxes | Registration, fuel |

#### Local/Municipal Government

| Typical Taxes | Characteristics |
|--------------|-----------------|
| Property tax | Primary local revenue source |
| Local income tax | Limited adoption |
| Business license taxes | Local business taxes |
| User fees | Service-specific charges |
...
• Personal income tax: 10-37% progressive
• Corporate income tax: 21% flat
• Payroll taxes: Social Security, Medicare
• No VAT/national sales tax

State Level (50 states):
• State income tax: 0% (9 states) to 13.3% (California)
• State sales tax: 0% (5 states) to 7.25% (California)
• State corporate tax: 0% (6 states) to 11.5% (New Jersey)

Local Level (thousands of jurisdictions):
• Property tax: Primary source (average ~1% of value)
• Local income tax: 16 states allow
...
```
Federal Level (Canada Revenue Agency - CRA):
• Personal income tax: 15-33% progressive
• Corporate income tax: 15%
• GST: 5%

Provincial Level (10 provinces, 3 territories):
• Provincial income tax: 4% to 21%
• Provincial sales tax (PST): 0% to 10%
• Provincial corporate tax: 8% to 16%
• Harmonized Sales Tax (HST): Combined GST+PST in some provinces

Municipal Level:
• Property tax: Primary revenue source
• Business taxes: Limited
```

#### Germany

```
Federal Level (Bundesregierung):
• Personal income tax: Shared with states
• Corporate tax: Shared
• VAT: Shared with states
• Insurance tax

State Level (16 Länder):
• Share of income tax revenue
• Inheritance tax
• Real property transfer tax

Municipal Level:
• Trade tax (Gewerbesteuer): Major local tax
• Property tax
• Local excises
```
...
### U.S. Model Convention Approach

The U.S. Model Tax Convention takes a unique position:
...
| Level | Residence Test | Issue |
|-------|----------------|-------|
| Federal | 183-day rule, green card | National standard |
...
|----------------|-----------|
| Filing requirements | Multiple returns at different levels |
| Tax rates | Must track rates for each jurisdiction |
| Tax base | May differ between federal and state |
...
- Advance Pricing Agreements (APAs) with IRS may not bind states
...
**Practical Implications for Multinational Enterprises (MNEs)**:
...
| Dispute resolution | Mutual Agreement Procedure (MAP) at federal level may not bind states | Consider state-specific resolution |
...
| Issue | Consideration |
|-------|--------------|
| **Residence changes** | May trigger state exit taxes |
| **Multi-state income** | Apportionment rules vary |
| **Credits for taxes paid** | State may credit other state taxes |
| **DTC benefits** | May not apply to state/local taxes |

### For Corporate Taxpayers

| Issue | Consideration |
|-------|--------------|
| **Nexus rules** | Each state has different thresholds |
| **Apportionment formulas** | Sales, payroll, property factors |
| **Unitary taxation** | Some states tax worldwide combined income |
| **Permanent establishment** | State rules may differ from federal |

### For Tax Authorities

| Issue | Consideration |
|-------|--------------|
| **Information exchange** | May not cover subnational taxes |
| **Administrative assistance** | Limited to treaty-covered taxes |
| **Competent authority** | Usually federal-level only |
...
| Level | Typical Taxes | Treaty Coverage |
|-------|--------------|-----------------|
| **Central/Federal** | Income tax, corporate tax, VAT | Always covered |
| **State/Regional** | Income tax, sales tax | Usually covered (except U.S.) |
| **Local/Municipal** | Property tax, local income | Usually covered (except U.S.) |

### Key Federal Countries Tax Structure

| Country | Federal Income Tax | State/Provincial Income Tax | Local Income Tax |
|---------|-------------------|---------------------------|------------------|
| **USA** | Yes | 41 states | 16 states allow |
| **Canada** | Yes | Yes (all provinces) | Limited |
| **Germany** | Yes (shared) | Yes (shared) | Trade tax |
| **Switzerland** | Yes (limited) | Yes (primary) | Yes (primary) |
| **Australia** | Yes | No | No |
| **India** | Yes (central) | Limited | Limited |
