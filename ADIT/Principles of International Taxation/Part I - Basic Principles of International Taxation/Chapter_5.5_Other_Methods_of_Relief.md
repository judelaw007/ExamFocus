# Chapter 5.5: Other Methods of Relief from International Double Taxation

## Relief by Deduction of Foreign Tax and Relief by Deferral
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Syllabus Reference: E.5 - Other methods of relief from international
                    double taxation – relief by deduction of foreign
                    tax; relief by deferral
...
Examiner Focus:
  ...
  • Deferral concept and its modern limitations (CFC, GILTI, Pillar Two)
  • Branch vs subsidiary structural implications
  • Comparison showing deduction as worst outcome for taxpayer

Note: Tax sparing credit is covered in E.1/Chapter 5.1 (Relief by Credit)
...
| Method | Mechanism | Relief Quality | Syllabus |
|--------|-----------|---------------|----------|
| **Credit** | Reduces tax liability | Full (within limits) | E.1 |
| **Exemption** | Excludes from tax base | Full | E.2 |
| **Deduction** | Reduces taxable income | **Partial only** | E.5 |
| **Deferral** | Postpones taxation | **Timing benefit** | E.5 |

Understanding deduction and deferral is essential for complete exam answers on relief methods, particularly December 2022 Q2-style questions requiring comprehensive system analysis.
...
• Deduction: Total tax = COMBINED effect (partial relief only)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
**Key point**: Even when foreign rate exceeds residence rate (last row), deduction still produces a higher total tax burden than credit.
...
2. NO TREATY IN PLACE
   ...
   → Credit may require treaty or specific domestic provisions

3. EXCESS FOREIGN TAX CREDITS
   When FTC exceeds limitation and cannot be carried
   → Some systems allow deduction for unutilizable excess

4. TAXPAYER ELECTION
   Some jurisdictions (e.g., US) allow choice between methods
   → Deduction may benefit taxpayers with losses or in
     specific planning situations

5. ADMINISTRATIVE SIMPLICITY
   Small amounts of foreign tax
   → Deduction simpler than credit compliance burden
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
**Historical origins**: Before credit systems developed, treating foreign taxes as expenses was intuitive—they are a cost of earning foreign income, like any other business expense.

**Fallback necessity**: When credit conditions aren't met (non-qualifying tax, no treaty), some relief is better than none. Deduction provides **partial** mitigation of double taxation.

**Simplicity**: No complex credit calculations, foreign tax verification, limitation analysis, or carry-forward tracking required.

**Neutrality argument**: From a pure economic perspective, deduction treats foreign taxes like any other cost—deductible but not refundable.
...
│                                                             │
│ DEFERRAL: 4 years of tax-free accumulation in R            │
└─────────────────────────────────────────────────────────────┘
...
### 2. Branch vs Subsidiary: Structural Choice

The availability of deferral historically drove structural decisions:

| Feature | Branch (PE) | Subsidiary |
|---------|-------------|------------|
| **Legal status** | Part of parent | Separate legal entity |
| **Taxation timing** | Current (as earned) | Deferred (until distributed) |
| **Deferral available** | No | Yes (historically) |
| **Loss utilization** | Immediate offset possible | Generally no group relief |
| **Exit taxation** | May be simpler | Dividend/capital gain issues |

This explains why MNCs historically preferred subsidiary structures—the deferral benefit often outweighed other considerations.
...
### 4. Modern Limitations on Deferral
...
│   • 13.125% rate (rising to 16.56% after Dec 2025)
...
STEP 2: Does SubCo have "CFC income"?
        ...
        • Income taxed at low effective rates
        • Certain mobile service income
...
RESULT: Deferral preserved only for "good" income
        (genuine active business, appropriately taxed,
        arm's length transactions)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```

### 6. GILTI and Pillar Two Impact (Current Developments 2024-2025)

**US GILTI (Global Intangible Low-Taxed Income)**:
- Introduced 2017 (Tax Cuts and Jobs Act)
- Taxes US shareholders currently on CFC income exceeding 10% return on tangible assets (QBAI)
- Current rate: **13.125%** (rising to **16.56%** after December 2025)
- Effectively ends deferral for most US multinationals
- Qualifies as "Blended CFC Tax Regime" under Pillar Two GloBE rules
- Simplified allocation formula for Pillar Two expires end of 2025

**Pillar Two GloBE Rules**:
- 15% global minimum effective tax rate
- If subsidiary income taxed below 15%, IIR top-up tax applies
- Even if technical deferral exists, benefit limited to 15% rate differential
- 22/27 EU Member States implemented by 2025
- Reduces incentive for low-tax deferral structures
...
|--------|-----------|---------------|------------------------|---------------|
| **Exemption** | Exclude from base | Source rate only | Yes | Primary (27/38 OECD) |
| **Credit** | Reduce tax liability | Higher of rates | Yes (within limits) | Primary method |
| **Deferral** | Postpone recognition | Same as credit (delayed) | Timing benefit only | Limited by CFC/GILTI/P2 |
...
```
TAXPAYER PREFERENCE RANKING (E.5 Methods Highlighted)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
2. DEFERRAL (E.5) ← THIS CHAPTER
   → Same ultimate rate as credit but time value benefit
   → Increasingly limited by CFC/GILTI/Pillar Two
   → Historical advantage now largely eroded

3. CREDIT (E.1)
   → Effective rate = higher of two rates
   → Full elimination of double taxation

4. DEDUCTION (E.5) ← THIS CHAPTER
...
### Answer Framework (Other Methods Section - 4-6 marks)
...
The effective rate under deduction **always exceeds** both individual country rates, leaving residual double taxation. Mathematically: Source rate + (1 - Source rate) × Residence rate.

Deduction is typically used as a **fallback** when:
- Foreign levy doesn't qualify as creditable income tax (e.g., DSTs)
- No treaty exists
- Administrative simplicity outweighs tax cost

**Policy consideration**: MRA should avoid deduction as primary method given its inferiority, but may retain as fallback for non-qualifying taxes where some relief is better than none.

**Relief by Deferral (2-3 marks)**

Deferral describes the **timing feature** whereby foreign subsidiary income is not taxed until distributed as a dividend, providing time value of money benefits. However, deferral has been progressively limited by:
- **CFC legislation**: Attributes "tainted" income (passive, related-party, low-tax) to parent currently through deemed distribution
- **US GILTI** (2017): Taxes most foreign income currently at reduced rate (13.125%, rising to 16.56%)
- **Pillar Two** (2024+): 15% global minimum limits benefit even where technical deferral exists

**Policy consideration**: Deferral is increasingly irrelevant as primary relief mechanism given modern anti-avoidance frameworks. MRA should consider CFC rules (BEPS Action 3) to prevent abuse of deferral while preserving it for genuine active business income.
...
4. OMITTING DEDUCTION/DEFERRAL IN COMPREHENSIVE QUESTIONS
   ✗ Only discussing credit and exemption
   ✓ December 2022 Q2 requires ALL systems—include
     deduction and deferral for complete answer

5. WRONG DEDUCTION CALCULATION
   ✗ Deducting foreign tax from tax liability
   ✓ Deduct from INCOME, then apply residence rate

6. TREATING DEFERRAL AS PERMANENT BENEFIT
   ✗ "Deferral eliminates residence-state tax"
   ✓ Tax is deferred, not eliminated; eventually payable
     (unless CFC rules intervene earlier)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
