## Chapter 2: Domestic Transfer Pricing Legislation

### 1. Introduction to Domestic Transfer Pricing Frameworks

#### 1.1. The Relationship Between Domestic Law and OECD Guidelines

While the OECD Transfer Pricing Guidelines provide internationally recognized best practices for applying the arm's length principle, they do not carry the force of law. Transfer pricing rules derive their legal authority from domestic legislation enacted by individual jurisdictions. Each country incorporates transfer pricing requirements into its national tax code, creating a framework that tax authorities can enforce and taxpayers must follow.

The relationship between domestic law and the OECD Guidelines varies significantly across jurisdictions. Some countries explicitly incorporate the Guidelines by legislative reference, making them part of domestic law. Others maintain independent legislative frameworks that align with OECD principles without formal incorporation. Still others adopt approaches that diverge from OECD recommendations in significant respects. Understanding these different approaches is essential for multinational enterprises navigating transfer pricing compliance across multiple jurisdictions.

#### 1.2. Scope of This Comparative Analysis

This chapter examines the domestic transfer pricing legislation of four major economies: the United States, the United Kingdom, Germany, and Australia. These jurisdictions were selected because they represent different approaches to incorporating transfer pricing principles into domestic law. The United States maintains the longest-standing transfer pricing regime and has historically influenced OECD thinking while retaining certain distinctive features. The United Kingdom represents an explicit incorporation approach. Germany exemplifies stringent documentation requirements that exceed OECD standards. Australia demonstrates a self-executing legislative framework with risk-based compliance guidance.

For each jurisdiction, this chapter identifies the primary legislative provisions, explains the relationship to OECD Guidelines, describes documentation requirements, and highlights distinctive features that differentiate each regime.
...
The operative details of the US regime appear not in the IRC itself but in the accompanying Treasury Regulations, particularly Treasury Regulation Section 1.482. These regulations, spanning hundreds of pages, provide detailed rules for applying transfer pricing methods to different categories of transactions, including tangible property, intangible property, services, and financial arrangements. The regulations specify acceptable transfer pricing methods, priority rules for method selection, and standards for documentation and contemporaneous analysis.

#### 2.2. The "Best Method" Rule

A distinctive feature of the US regime is the "best method" rule, which differs subtly but significantly from the OECD's "most appropriate method" approach. Under Treasury Regulation 1.482-1(c), the arm's length result is determined using the method that provides the most reliable measure of an arm's length result under the facts and circumstances. Factors considered in selecting the best method include the degree of comparability between controlled and uncontrolled transactions, the quality of data and assumptions, and the sensitivity of results to deficiencies in data.
...
### 3. United Kingdom Transfer Pricing Regime
...
For many years, the United Kingdom did not mandate specific transfer pricing documentation, instead expecting taxpayers to maintain records sufficient to support their tax returns. This changed effective April 1, 2023, when the UK introduced mandatory master file and local file requirements aligned with the OECD's BEPS Action 13 recommendations.
...
Germany's transfer pricing legislation is primarily contained in Section 1 of the Außensteuergesetz (Foreign Tax Act, abbreviated AStG). Section 1 AStG requires that transactions between related parties be conducted on arm's length terms and authorizes adjustments where actual arrangements deviate from what independent parties would have agreed. The provision applies to both cross-border transactions and certain domestic arrangements.

Paragraph 1 establishes the fundamental arm's length principle, requiring that income from business relationships with related foreign entities be determined as if the relationships were between independent third parties. Paragraph 3 addresses the documentation of transfer pricing policies, imposing some of the most stringent documentation requirements found in any jurisdiction. The legislative framework is supplemented by detailed administrative guidance and regulations that specify documentation content, submission deadlines, and penalty provisions.

#### 4.2. Documentation Requirements and the Transaction Matrix
...
Australia's transfer pricing rules are contained in Division 815 of the Income Tax Assessment Act 1997 (ITAA 1997). This Division, introduced in 2013, replaced earlier provisions and modernized Australia's transfer pricing framework to align with OECD Guidelines. Division 815 is divided into several subdivisions, each addressing different aspects of transfer pricing.

Subdivision 815-A contains definitions and general provisions. Subdivisions 815-B and 815-C contain the operative transfer pricing rules for cross-border arrangements between related parties. Subdivision 815-D addresses administrative matters including documentation. The legislative structure reflects Australia's comprehensive approach to incorporating transfer pricing principles into domestic law.

#### 5.2. The Self-Executing Approach

A distinctive feature of the Australian regime is found in Subdivision 815-B, which is described as "self-executing." Under this approach, if conditions of related-party dealings differ from arm's length conditions, the actual profits or losses for Australian tax purposes are automatically substituted with what profits or losses would have been under arm's length conditions. This substitution occurs by operation of law without requiring a determination by the Australian Taxation Office (ATO).

The self-executing nature of Subdivision 815-B places the primary responsibility for transfer pricing compliance on taxpayers themselves. Taxpayers must self-assess whether their arrangements meet arm's length standards and, if not, must self-adjust their taxable income accordingly. The ATO retains authority to review these self-assessments and make adjustments where it disagrees, but the initial compliance obligation rests with the taxpayer.

This approach differs from regimes where transfer pricing adjustments require affirmative action by tax authorities. It reflects Australia's broader system of self-assessment taxation, where taxpayers prepare returns based on their understanding of the law and tax authorities conduct subsequent reviews.

#### 5.3. Risk Zone System and Practical Compliance
...
The following table summarizes key features of the four jurisdictions examined:

| Element | United States | United Kingdom | Germany | Australia |
|---------|--------------|----------------|----------|-----------|
| Primary Legislation | IRC §482 | TIOPA 2010 | AStG §1 | ITAA 1997 Div 815 |
| OECD Alignment | Independent but aligned | Explicit incorporation | Aligned | Aligned |
| Method Selection | Best method | Most appropriate | Most appropriate | Most appropriate |
| Documentation | Recommended | Mandatory (2023) | Mandatory (most strict) | Recommended |
| Master/Local File | Not required | Required | Required + Transaction Matrix | Not required |
| Penalties | 20-40% underpayment | Standard tax penalties | EUR 5k-1m documentation | Standard tax penalties |

#### 6.2. Key Differences and Convergence

Despite different legislative approaches, significant convergence exists across these four jurisdictions in their application of the arm's length principle. All four accept the fundamental premise that related-party transactions should be priced as if conducted between independent parties. All four recognize the transfer pricing methods described in OECD Guidelines, even where domestic legislation uses different terminology.
