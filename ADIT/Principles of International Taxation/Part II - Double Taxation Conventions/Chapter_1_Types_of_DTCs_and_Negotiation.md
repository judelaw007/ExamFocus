...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    (Full DTC coverage)                  (Specific focus)
            │                                   │
    • Income and Capital                        │
    • All distributive rules        ┌──────────┼──────────┐
    • Relief methods                │          │          │
    • Administrative provisions     ▼          ▼          ▼
                                 TIEAs      Shipping/   Inheritance
                                           Airlines    Tax Treaties
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
STEP 1: SIGNING
Country A signs MLI → Lists CTAs (Covered Tax Agreements)
Country B signs MLI → Lists CTAs

STEP 2: MATCHING
                    A-B Bilateral Treaty
                           │
        ┌──────────────────┼──────────────────┐
        │                  │                  │
     ...
     as CTA?              │              as CTA?
        │                 │                  │
        ▼                 ▼                  ▼
     YES + compatible   BOTH must        YES + compatible
     choices on         match for        choices on
     provisions         modification     provisions
                          │
                          ▼
               "SYNTHESISED TEXT"
               (Original DTC + MLI modifications)
...
┌─────────────────────────────────────────────────────────────────┐
│ • Policy decision to pursue treaty                             │
│ • Economic cost-benefit analysis                               │
│ • Selection of model convention as base                        │
│ • Identification of country-specific concerns                  │
│ • Assembly of negotiating team                                 │
└─────────────────────────────────────────────────────────────────┘
                              │
                              ▼
...
│ • Bilateral discussions (multiple rounds)                      │
│ • Article-by-article negotiation                               │
│ • Resolution of differences                                    │
│ • Drafting of protocols/agreed memoranda                       │
└─────────────────────────────────────────────────────────────────┘
                              │
                              ▼
PHASE 3: CONCLUSION
┌─────────────────────────────────────────────────────────────────┐
│ • Initialling of agreed text                                   │
│ • Legal review and translation                                 │
│ • Formal signature by authorised representatives               │
...
└─────────────────────────────────────────────────────────────────┘
                              │
                              ▼
ONGOING: AMENDMENT/PROTOCOL
┌─────────────────────────────────────────────────────────────────┐
│ • Periodic review and update                                   │
│ • Protocol negotiations                                        │
│ • Often as slow and difficult as original negotiation          │
└─────────────────────────────────────────────────────────────────┘
...
|-----------|-------------|
| **Asymmetric bargaining power** | Developed countries often have greater negotiating capacity and expertise |
| **Revenue implications** | Developing countries may cede valuable taxing rights |
| **Technical complexity** | Requires specialised expertise many countries lack |
| **Time and resources** | Negotiations can take years; significant staff commitment |
